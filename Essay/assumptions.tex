...
\begin{description}
    ...
    \item[Assumption 2: Rational Judges' Save.] We assume judges consistently save the couple with the higher technical score when deciding between the bottom two.
    ...
    \item[Assumption 4: Constant Vote Volume.] We assume a constant total weekly vote volume ($V_{total} = 14$ million) to normalize cross-season comparisons.

    \item[Model II: Characteristic Analysis]
    ...
    \item[Model IV: Adaptive Logistic Meritocracy System]
