...
their favorite celebrities' popularity than on-stage performance.
...
\begin{itemize}
    ...
    \item \textbf{Judges' Save:} The elimination is valid if the actual eliminated contestant falls within the \textbf{Bottom-2} (the risk zone), making them eligible for elimination.
\end{itemize}
