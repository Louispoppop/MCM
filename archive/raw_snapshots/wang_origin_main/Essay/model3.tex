\section{Model III: Macro-Comparative Analysis of Aggregation Rules}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{model3_imgs/Task2_Subtask1_Boxplot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{model3_imgs/Task2_Subtask1_BarChart.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{model3_imgs/Task2_Subtask2_Timeline_Bristol_Palin_S11.png}
        \subcaption{Bristol Palin (S11)}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{model3_imgs/Task2_Subtask2_Timeline_Bristol_Palin_S15.png}
    ...
    \begin{minipage}{0.32\textwidth}
        \centering
        \includegraphics[width=\linewidth]{model3_imgs/Task2_Subtask2_Timeline_Jerry_Rice_S2.png}
        \subcaption{Jerry Rice (S2)}
    \end{minipage}\hfill
    \begin{minipage}{0.32\textwidth}
        \centering
        \includegraphics[width=\linewidth]{model3_imgs/Task2_Subtask2_Timeline_Billy_Ray_Cyrus_S4.png}
        \subcaption{Billy Ray Cyrus (S4)}
    \end{minipage}\hfill
    \begin{minipage}{0.32\textwidth}
        \centering
        \includegraphics[width=\linewidth]{model3_imgs/Task2_Subtask2_Timeline_Bobby_Bones_S27.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{model3_imgs/Task2_Subtask3_Sensitivity.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{model3_imgs/Task2_Subtask3_Risk.png}
